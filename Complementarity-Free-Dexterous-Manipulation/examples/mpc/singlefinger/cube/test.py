...
from examples.mpc.singlefinger.cube.params import ExplicitMPCParams
...
save_flag=False
if save_flag:
    save_dir = './examples/mpc/singlefinger/cube/save/'
...
while trial_count < trial_num:
    ...
    #        init parameters
    # -------------------------------
    param = ExplicitMPCParams(rand_seed=trial_count, target_type='ground-rotation')
